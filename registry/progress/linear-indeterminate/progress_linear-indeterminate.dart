...
class LinearProgressIndeterminate extends StatefulWidget {
  const LinearProgressIndeterminate({super.key});

  @override
  State<LinearProgressIndeterminate> createState() => _LinearProgressIndeterminateState();
}

class _LinearProgressIndeterminateState extends State<LinearProgressIndeterminate>
