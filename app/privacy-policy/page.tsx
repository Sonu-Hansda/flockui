    ...
    <div className="min-h-screen bg-white dark:bg-slate-900 transition-colors duration-200">
      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <div className="prose prose-slate dark:prose-invert max-w-none">
          ...
          <h2 className="text-2xl font-extrabold text-slate-900 dark:text-white mt-10 mb-4">1. What Information We Collect</h2>

          <h3 className="text-lg font-bold text-slate-900 dark:text-white mt-8 mb-3">1.1 Analytics Data (Automatic)</h3>
          <p>
          ...
          <h3 className="text-lg font-bold text-slate-900 dark:text-white mt-8 mb-3">1.2 Information You Voluntarily Provide</h3>
          <p>
          ...
          <h3 className="text-lg font-bold text-slate-900 dark:text-white mt-8 mb-3">1.3 What We Do NOT Collect</h3>
          ...
          <h2 className="text-2xl font-extrabold text-slate-900 dark:text-white mt-10 mb-4">2. How We Use Your Information</h2>
          ...
          <h2 className="text-2xl font-extrabold text-slate-900 dark:text-white mt-10 mb-4">3. Cookies and Tracking</h2>
          <p>
          ...
          <p>
            For more details, please see our <a href="/cookie-policy" className="text-flutter-blue dark:text-flutter-sky hover:underline">Cookie Policy</a>.
          </p>

          <h2 className="text-2xl font-extrabold text-slate-900 dark:text-white mt-10 mb-4">4. Data Storage and Security</h2>
          <p>
          ...
          <h2 className="text-2xl font-extrabold text-slate-900 dark:text-white mt-10 mb-4">5. Third-Party Services</h2>
          <p>We use the following third-party services:</p>
          <ul>
            <li><strong>Vercel</strong> — for hosting and analytics. <a href="https://vercel.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer" className="text-flutter-blue dark:text-flutter-sky hover:underline">View their privacy policy</a>.</li>
            <li><strong>GitHub</strong> — for source code hosting and issue tracking. <a href="https://docs.github.com/en/site-policy/privacy-policies/github-general-privacy-statement" target="_blank" rel="noopener noreferrer" className="text-flutter-blue dark:text-flutter-sky hover:underline">View their privacy statement</a>.</li>
          </ul>
          <p>
          ...
          <h2 className="text-2xl font-extrabold text-slate-900 dark:text-white mt-10 mb-4">6. Your Rights</h2>
          ...
          <h2 className="text-2xl font-extrabold text-slate-900 dark:text-white mt-10 mb-4">7. Data Retention</h2>
          <p>
          ...
          <h2 className="text-2xl font-extrabold text-slate-900 dark:text-white mt-10 mb-4">8. Children's Privacy</h2>
          <p>
          ...
          <h2 className="text-2xl font-extrabold text-slate-900 dark:text-white mt-10 mb-4">9. Changes to This Policy</h2>
          <p>
          ...
          <h2 className="text-2xl font-extrabold text-slate-900 dark:text-white mt-10 mb-4">10. Contact Us</h2>
          <p>
