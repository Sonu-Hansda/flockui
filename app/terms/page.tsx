    ...
    <div className="min-h-screen bg-white transition-colors duration-200">
      ...
      <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="prose prose-slate max-w-none">
          ...
          <h2 className="text-2xl font-extrabold text-slate-900 mt-10 mb-4">1. Acceptance of Terms</h2>
          <p>
          ...
          <h2 className="text-2xl font-extrabold text-slate-900 mt-10 mb-4">2. Description of Service</h2>
          <p>
          ...
          <h2 className="text-2xl font-extrabold text-slate-900 mt-10 mb-4">3. License</h2>
          <p>
          ...
          <p>
            The full license text is available in the <a href="https://github.com/Sonu-Hansda/flockui/blob/main/LICENSE" target="_blank" rel="noopener noreferrer" className="text-flutter-blue hover:underline">LICENSE</a> file in our GitHub repository.
          </p>

          <h2 className="text-2xl font-extrabold text-slate-900 mt-10 mb-4">4. Contributions</h2>
          <p>
          ...
          <h2 className="text-2xl font-extrabold text-slate-900 mt-10 mb-4">5. User Responsibilities</h2>
          ...
          <h2 className="text-2xl font-extrabold text-slate-900 mt-10 mb-4">6. Intellectual Property</h2>
          <p>
          ...
          <h2 className="text-2xl font-extrabold text-slate-900 mt-10 mb-4">7. Disclaimer of Warranties</h2>
          <p>
          ...
          <h2 className="text-2xl font-extrabold text-slate-900 mt-10 mb-4">8. Limitation of Liability</h2>
          <p>
          ...
          <h2 className="text-2xl font-extrabold text-slate-900 mt-10 mb-4">9. Termination</h2>
          <p>
          ...
          <h2 className="text-2xl font-extrabold text-slate-900 mt-10 mb-4">10. Governing Law</h2>
          <p>
          ...
          <h2 className="text-2xl font-extrabold text-slate-900 mt-10 mb-4">11. Changes to Terms</h2>
          <p>
          ...
          <h2 className="text-2xl font-extrabold text-slate-900 mt-10 mb-4">12. Contact Us</h2>
          <p>
